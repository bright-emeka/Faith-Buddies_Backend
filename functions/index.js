...
import { registerUser, syncUserProfile, getUserProfile, searchUsers, repairUserUids, migrateFirebaseUsers } from './src/controllers/userController.js';
...
const route = (req, res) => {
  ...
  if (segments[0] === 'users') {
    ...
    if (segments[1] === 'migrate' && method === 'post') {
      return authenticate(req, res, () => migrateFirebaseUsers(req, res));
    }
